    ...
    <>
      <div className="flex h-full flex-col">
        ...
        <div className="flex-grow-1 overflow-auto">
          ...
          <p className="m-3">
            Robot Karol lebt in einem Objekt der Klasse Welt. Es wird
            normalerweise immer eine Welt erstellt.
          </p>
          <div className="m-3 mb-6">
            <table className="border-collapse border table-fixed w-full">
              <thead>
                <tr>
                  <th className="border w-[300px] text-left p-2">
                    Konstruktor
                  </th>
              ...
              <tbody>
                <tr>
                  ...
                  <td className="border text-left p-2">
                    Erzeugt eine neue Welt mit folgender Standardgröße: Breite
                    5, Länge 5, Höhe 6.
                  </td>
                </tr>
                <tr>
                  ...
                  <td className="border text-left p-2">
                    Erzeugt eine neue Welt mit der angegebenen Breite und Länge
                    und der Standardhöhe 6.
                  </td>
                </tr>
                <tr>
                  <td className="border text-left p-2 font-mono">
          ...
          <p className="m-3">
            Ein Roboter-Objekt in einer Welt, kann auf viele Arten gesteuert
            werden.
          </p>
          <div className="m-3 mb-6">
            <table className="border-collapse border table-fixed w-full">
          ...
          <div className="m-3 mb-6">
            <table className="border-collapse border table-fixed w-full">
              <thead>
                <tr>
                  <th className="border w-[300px] text-left p-2">Methode</th>
                  <th className="border text-left p-2">Beschreibung</th>
                </tr>
              </thead>
              <tbody>
